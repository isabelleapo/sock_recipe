...
def create_sock_router() -> APIRouter:
    ...
    def get_heel_stitch_sections(size: str, yarn_weight: str) -> Tuple[int, int, int]:
        """
    ...
    def get_full_pattern(size: str, yarn_weight: str) -> PlainTextResponse:
        """
